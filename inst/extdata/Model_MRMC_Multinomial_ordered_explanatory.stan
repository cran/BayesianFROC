// Model_MRMC_Multinomial_ordered_explanatory
...
parameters{
  ...
  real               mu0;// 2020 Dec 17
  real <lower=0>      v0;// 2020 Dec 17

  real               alphaM[M];// 2020 Dec 17
  real <lower=0>     alphaQ[Q];// 2020 Dec 17
...
transformed parameters {
  ...
  real               mu[M,Q];// 2020 Dec 17
  real <lower=0>      v[M,Q];// 2020 Dec 17
  ...
  real <lower=0,upper=1>A[M];
    ...
    for(md in 1 : M) {
    for(qd in 1 : Q) {
      // mu[md,qd] =  mu0+ md*alphaM[md] + qd*alphaQ[qd];
      // v[md,qd] =  v0* exp( md*alphaM[md] + qd*alphaQ[qd]);
            mu[md,qd] =  mu0+ alphaM[md] + alphaQ[qd];
      v[md,qd] =  v0* exp( alphaM[md] + alphaQ[qd]);
