...
#'
#'
#' @param ww A real number, representing a parameter of prior, indicating mean of prior for the first threshold
#' @param www A real number, representing a parameter of prior, variance of prior for the first threshold
#' @param mm A real number, representing a parameter of prior, mean of prior for the mean of signal distribution
#' @param mmm A real number, representing a parameter of prior, variance of prior for the variance of signal distribution
#' @param vv A real number, representing a parameter of prior,  mean of prior for the mean of signal distribution
#' @param vvv  A real number, representing a parameter of prior, variance of prior for the variance of signal distribution
#' @param zz A real number, representing a parameter of prior, mean of prior for the  differences of thresholds
#' @param zzz A real number, representing a parameter of prior, variance of prior for the  differences of thresholds
...
#'
#' @param prior An integer, representing type of priors
...
Simulation_Based_Calibration_single_reader_single_modality_via_rstan_sbc <- function(
                 ...
                 XXX=1,YYY=1,ite=3333,
                 # old_ver = T,
                 model_reparametrized = FALSE,


                 NL = 259, NI = 57,C=3, prior =1,M = 500
                 ){
  ...
  scr <-system.file("extdata", "SBC.stan",  package = "BayesianFROC")
...
* We will obtain rank statistics by the SBC algorithm.
  If the histograms are uniformly distributed,
