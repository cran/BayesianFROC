...
#'
#'
#'@description  New Slots are added to  \strong{\emph{\code{\link[rstan]{stanfit}}}}  which is an S4 class defined in  the package \strong{\emph{rstan }} :
...
#'@slot chisquare This is a chi square calculated with Expected A Posterior estimates, i.e., the posterior mean estimator. Note that this is \emph{not} calculated by integrating the posterior predictive measure.
