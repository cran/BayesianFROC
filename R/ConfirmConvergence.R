...
#'@param StanS4class That is an S4 object, whose class is named \code{stanfit} in the rstan package. This is an output of \code{rstan::stan()}, and not restricted in the author's Bayesian model.
