...
<span style="color:blue">**_modalities_** </span> 
 
## Aims  
 - Compare <span style= "font-size :1.3em">**_modalities_** </span>( such as MRI, CT, PET,...etc, or treatment).
...
This package provides the solution of this <span style="color:blue">**_modalities_** </span>  comparison issue by Bayesian approaches.
